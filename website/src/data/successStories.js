...
export default [{
        ...
        quote: ( <
            >
            Preparing
            for my first rounds of tech interviews was really daunting - I wasn 't sure what to expect and where to start. This handbook together
            with the {
                ' '
            } <
            a href = "https://github.com/bgoonz/front-end-interview-handbook"
            target = "_blank"
            rel = "noreferrer noopener" >
            Front End Interview Handbook <
            /a>{' '}
            was a great starting point
            for me.It clearly describes each part of the process and has tons of awesome tips and resources.With this handbook and lots of practice, I managed to get offers from Facebook, Dropbox and Amazon!
            <
            />
        ),
    },
    {
        ...
        quote: ( <
            ...
            for helping me land my dream job at Google!
            <
            />
        ),
    },
    {
        ...
        quote: ( <
            >
            The Tech Interview Handbook played a crucial role in the success of my previous job search.The contents are carefully curated and well organized.It served as an excellent roadmap
            for my interview prep. <
            br / >
            <
            br / >
            ...
            <
            br / >
            With the help of Tech Interview Handbook, I was able to land offers from Google, Amazon, Uber and several other great companies.Really appreciate bgoonz and other contributors
            for putting out such quality content
            for the community.I 'd wholeheartedly recommend this handbook to
            anyone!
            <
            />
        ),
